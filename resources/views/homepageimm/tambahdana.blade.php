    ...
    <form action="{{ route('companyIncome.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="funding_type" name="funding_type" required>
                ...
                <option value="Pre Seed">Pendanaan Pre-Seed</option>
                <option value="seed">Pendanaan Seed</option>
                <option value="Series A">Pendanaan Series A</option>
                <option value="Series B">Pendanaan Series B</option>
                <option value="Series C">Pendanaan Series C</option>
                <option value="Series D">Pendanaan Series D</option>
                <option value="Series E">Pendanaan Series E</option>
                <option value="Series F">Pendanaan Series F</option>
                <option value="Series G">Pendanaan Series G</option>
                <option value="Series H">Pendanaan Series H</option>
                <option value="Series I">Pendanaan Series I</option>
                <option value="Series J">Pendanaan Series J</option>
